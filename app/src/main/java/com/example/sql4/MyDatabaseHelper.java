...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "Waitinglist.db";
    ...
    void addBook(String course_name, String student_name, int grade){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_COURSE, course_name);
    ...
    void updateData(String row_id, String course_name, String student_name, String grade){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_COURSE, course_name);
        cv.put(COLUMN_NAME, student_name);
